function Apropos(){
    ...
    <h2 className="text-orange-900 text-2xl font-bold inline-block border-b-4 rounded border-blue-950 pb-3">Notre mission</h2>
    ...
    <h2 className="text-orange-900 text-2xl font-bold inline-block border-b-4 rounded border-blue-950 pb-3">Ce que vous pouvez faire</h2>
    
    
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-10">
      
      <div className="flex flex-col items-center gap-2 bg-neutral-50 p-6 rounded-xl">
        <img className="w-15 h-15" src="/chaussures.png" alt="maroc"/>
        <h3 className="text-blue-950 text-xl font-semibold mb-2">Explore les creations</h3>
      ...
      <div className="flex flex-col items-center gap-2 bg-neutral-50 p-6 rounded-xl">
        ...
        <h3 className="text-blue-950 text-xl font-semibold mb-2">Participer aux evenements</h3>
        <p className="text-gray-600 text-sm">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae quasi at ipsa eius, delectus animi, illum nulla quo temporibus sequi velit culpa, similique adipisci ratione maiores rem facere? Quisquam, placeat.
        </p>
      </div>
      ...
      <div className="flex flex-col items-center gap-2 bg-neutral-50 p-6 rounded-xl">
        ...
        <h3 className="text-blue-950 text-xl font-semibold mb-2">Sauvegarder vos favoris</h3>
        <p className="text-gray-600 text-sm">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae quasi at ipsa eius, delectus animi, illum nulla quo temporibus sequi velit culpa, similique adipisci ratione maiores rem facere? Quisquam, placeat.
        </p>
      </div>
  ...
  <section className="px-6 py-12 max-w-5xl mx-auto flex flex-col md:flex-row gap-6 items-center">
    <div className="md:w-1/2">
      <img src="/image.19.jpg" 
           alt="Maroc" className="rounded-lg shadow-lg"/>
    </div>
    <div className="md:w-1/2">
      <h2 className="text-orange-900 text-2xl font-bold inline-block border-b-4 rounded border-blue-950 pb-3">Notre Histoire</h2>
  ...
  <section className=" px-6 py-15 bg-gray-50">
    <div className="text-center mb-8">
    <h2 className="text-orange-900 text-2xl font-bold inline-block border-b-4 rounded border-blue-950 pb-3 mb-6">Nos Valeurs</h2>
    </div>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-9 max-w-5xl mx-auto">
      ...
      <div className="flex gap-3">
        ...
        <div>
        <h3 className="text-blue-950 text-xl font-semibold mb-2">Authenticité</h3>
        <p className="text-gray-600 text-sm">
      ...
      <div className="flex gap-3">
        ...
        <div>
        <h3 className="text-blue-950 text-xl font-semibold mb-2">Innovation</h3>
        <p className="text-gray-600 text-sm">
          Lorem, ipsum dolor sit amet consectetur 
        </p>
        </div>
      ...
      <div className="flex gap-3">
        ...
        <div>
        <h3 className="text-blue-950 text-xl font-semibold mb-2">Communaute</h3>
        <p className="text-gray-600 text-sm">
          Lorem, ipsum dolor sit amet consectetur 
        </p>
        </div>
